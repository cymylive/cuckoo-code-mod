...
function showWindows() {
  ...
  if (wins.length === 0) {
    ...
    if (typeof global.__cuckooCreateWindow === 'function') {
      global.__cuckooCreateWindow();
    }
    return;
  }
...
function getAutoLaunchFlagPath() {
  return path.join(app.getPath('userData'), 'cuckoo-autolaunch.json');
}
